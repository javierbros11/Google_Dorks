...
if __name__ == "__main__":
    ...
    parser.add_argument("dir_path", type=str, help="La ruta al directior donde se encuentran los ficheros.")
    parser.add_argument("-r","--regex", type=str, help="La expresión regular para realizar la búsqueda")
    parser.add_argument("-p","--prompt",type=str,help="Prompt para realizar la búsqueda con GPT")
    parser.add_argument("-m","--model",type=str,default="gpt-3.5-turbo-0125",help="El nombre del modelo de OpenAI para realizar la búsqueda")
    parser.add_argument("--max-tokens",type=int,default=100,help="Número max de tokens en la predicción/generación.")
    ...
    if args.regex:
        ...
        for index,value in resultados.items():
            print(f"Para este archivo {index}")
            for i in value:
                print(f"Se ha encontrado: '{i}'")
